 ...
 * Handles theme toggle (white mode default), navigation, hero slideshow (3s timer), forms, and WhatsApp triggers.
 */
...
function initHeroSlider() {
  ...
  const slideDuration = 3000; // 3 seconds per prompt requirement
